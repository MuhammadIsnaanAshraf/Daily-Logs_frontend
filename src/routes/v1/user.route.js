...
router.get('/counts', userController.userAnalytics);
router.patch('/profile',auth({action:actions.update, subject: subjects.profile}), validate(userValidation.updateProfile), userController.updateProfile);
